...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama, mesa e banho'),(4,'Eletrônicos'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumaria'),(8,'Descartaveis');
...
INSERT INTO `cliente` VALUES (1,'81572727853','marcelo@email.com','Marcelo Salvador',1);
...
INSERT INTO `endereco` VALUES (1,'Santana','02345010','Casa 2','Rua das Quinta','76',1,1),(2,'Alfenas','04235100','12 Andar','Rua Ministro Antonio Luiz','390',2,1);
...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2018-05-20 00:00:00',2);
...
INSERT INTO `pedido` VALUES (1,'2018-05-10 07:55:00',1,1),(2,'2018-05-17 09:36:00',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de escritorio',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV True Color',1200),(8,'Alicate',30),(9,'Shampoo',80),(10,'Tonner',160),(11,'Perfume',40);
...
INSERT INTO `produto_categoria` VALUES (1,1),(1,4),(2,1),(2,2),(2,4),(3,1),(3,2),(4,2),(5,3),(6,3),(7,4),(8,5),(9,6),(10,6),(11,7);
...
INSERT INTO `telefone` VALUES (1,'997768750'),(1,'24097712');
...
-- Dump completed on 2018-06-02 21:01:00
